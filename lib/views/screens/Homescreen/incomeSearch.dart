  ...
  Future dataentry(type, subtype, name, notes, amount, date) async {
    if (typecontroller.text.isNotEmpty ||
      ...
      var response = await http.post(Uri.parse(
          "${dotenv.env['API_URL']}/api/method/money_management_backend.custom.py.api.daily_entry_submit?Type=Income&Subtype=${subtype}&Name=${name}&Notes=${notes}&Amount=${amount}&Remainder_date=${date}"));

  ...
  Future uploadimage() async {
    FormData formData = FormData.fromMap({
      "file": await MultipartFile.fromFile(
        '/data/user/0/com.example.money_manager/cache/file_picker/IMG-20220323-WA0001.jpg',
        filename: 'IMG-20220323-WA0001.jpg',
      ),
...
// [PlatformFile(path /data/user/0/io.frappe.frappe_mobile/cache/file_picker/IMG-20220323-WA0002.jpg, name: IMG-20220323-WA0002.jpg, bytes: null, readStream: null, size: 96605)
  Future uploadFiles() async {
    FormData formData = FormData.fromMap({
      "file": await MultipartFile.fromFile(
        '/data/user/0/io.frappe.frappe_mobile/cache/file_picker/IMG-20220323-WA0002.jpg',
        filename: 'IMG-20220323-WA0002.jpg',
      ),
      "docname": 'barathpalanisamy2002@gmail.com',
      "doctype": 'User',
      "is_private": 0,
    ...
    dio.options.headers["Authorization"] = prefs.getString('token') ?? "";
    var response = await dio.post(
        "http://192.168.101.54:8002/api/method/upload_file",
        data: formData);
    print(dio);
    print(response);
    if (response.statusCode == 200) {
